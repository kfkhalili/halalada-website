...
export const TwitterButton: React.FC<SpecificSocialButtonProps> = (props) => (
  <SocialButton {...props} icon={faTwitter} href="https://x.com/halaladapool" />
);
...
export const GithubButton: React.FC<SpecificSocialButtonProps> = (props) => (
  <SocialButton
    {...props}
    icon={faGithub}
    href="https://github.com/FantasiaCode"
  />
);

export const DiscordButton: React.FC<SpecificSocialButtonProps> = (props) => (
  <SocialButton
    {...props}
    icon={faDiscord}
    href="https://discord.gg/rzxvrPD3"
  />
);

export const MediumButton: React.FC<SpecificSocialButtonProps> = (props) => (
  <SocialButton
    {...props}
    icon={faMedium}
