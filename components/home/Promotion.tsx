      ...
      <div className="container lg:flex flex-row gap-8 mx-auto pl-6 sm:pl-0 pr-6 sm:pr-0">
        <div className="flex flex-col items-start justify-center w-full lg:w-1/2 mb-16 lg:mb-0">
          ...
          <p className="c-white mb-8">
            Loyality program for all who delegate their ADA Wallet to Halal ADA
          </p>
          <a
            href="https://cexplorer.io/pool/pool1uhdcmcn36vq8kk3207tqjwp90t0nwr49pc498wh5vxmgqyr78d5"
            target="_blank"
        ...
        >
          <div className="p-8 lg:p-14 rounded-md c-dark bg-main">
            ...
            The longer you stake with Halal ADA the higher the chance to win.
          </div>
        </div>
      </div>
    </section>
