  ...
  return (
    <div>
      ...
      <section className="container py-36 mx-auto">
        <h1 className="heading-hero mb-36">Style Guide</h1>
        <h2 className="c-white uppercase mb-8 text-5xl">Color Pallete</h2>
        <hr className="mb-8" />
        <div className="flex gap-8 mb-20">
          ...
          <div
            className="rounded-full w-60 h-40 c-white flex items-center justify-center text-center"
          ...
          <div
            className="w-96 h-40 c-white flex items-center justify-center text-center p-4 rounded-full"
            style={{
              background:
                "linear-gradient(35deg, rgba(168, 212, 185, 1) 0%, rgba(255, 255, 255, 0.04) 90%);",
            }}
          >
            Hero Gradient
            <br />
            ...
            linear-gradient
            <br />
            (35deg, rgba(168, 212, 185, 1) 0%, rgba(255, 255, 255, 0.04) 90%);
          </div>
        </div>

        <h2 className="c-white uppercase mb-8 text-5xl">Typography</h2>
        <hr className="mb-8" />
        <p className="c-white text-2xl">Poppins</p>
        <div className="c-white mt-12 mb-20">
          ...
          <p className="c-white">Paragraph - 16px</p>
        </div>
        <h2 className="c-white uppercase mb-8 text-5xl">Buttons</h2>
        <hr className="mb-8" />
